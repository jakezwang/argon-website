...
import FunnelChoice from "./components/Funnel";
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Argon — a database branch for every AI agent",
      },
    ],
  },
  twitter: {
      ...
      <div className="grid grid-cols-2 gap-10 md:grid-cols-5">
        <div className="col-span-2">
          ...
          <p className="mt-4 max-w-xs text-sm leading-6 text-brand-muted">
            ...
            noble gas: experiments stay on branches until you explicitly merge
            them.
          </p>
        </div>
        <FooterColumn
        ...
        <FooterColumn
          ...
          links={[
            ...
            {
              label: "Documentation",
              href: "https://github.com/argon-lab/argon/tree/master/docs",
              external: true,
            },
            {
              label: "Discussions",
            ...
            {
              label: "Issues",
              href: "https://github.com/argon-lab/argon/issues",
              external: true,
            },
          ]}
        />
